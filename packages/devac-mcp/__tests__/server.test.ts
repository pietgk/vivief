...
describe("DevacMCPServer", () => {
  ...
  describe("initialization", () => {
    ...
    it("has correct tool count in status before start", () => {
      ...
      expect(status.toolCount).toBe(15); // find_symbol, get_dependencies, get_dependents, get_file_symbols, get_affected, get_call_graph, query_sql, list_repos, get_context, get_validation_errors, get_validation_summary, get_validation_counts, get_all_feedback, get_feedback_summary, get_feedback_counts
    });
  });
