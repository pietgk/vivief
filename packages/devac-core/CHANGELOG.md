...
- 2c8b254: Add shared query layer for CLI and MCP
...
- fdc7093: Auto-stop MCP on version mismatch for better DX
...
- 25dba08: Add unified addressing scheme with single identity model (ADR-0044)
