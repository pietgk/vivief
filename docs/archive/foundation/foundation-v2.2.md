...
**DevAC already does Phase 1** - the Universal AST extraction produces seeds without requiring rules. Rules are an enhancement layer, not a prerequisite.
...
*Version: 2.2 - Added Effect Store, Rules, Bootstrap, Implementation Readiness*
