...
**Terminology note:** In DevAC's Three Pillars model (see [concepts.md](../vision/concepts.md)), **Validators** produce **Diagnostics**. Coverage is one such validator, producing diagnostics about untested code.
